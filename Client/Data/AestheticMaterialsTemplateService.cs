    ...
    public class AestheticMaterialsTemplateService : BaseMaterialsTemplateService
    {
        protected override void CreateTemplates()
        {
            _templates = new List<TemplatePerSchool>
            {
                ...
                new TemplatePerSchool("feathers", new List<SchoolOfMagic>{ SchoolOfMagic.Conjuration, SchoolOfMagic.Evocation, SchoolOfMagic.Divination }),
                ...
                new TemplatePerSchool("leaves and vines", new List<SchoolOfMagic>{ SchoolOfMagic.Divination, SchoolOfMagic.Conjuration }),
                new TemplatePerSchool("branches", new List<SchoolOfMagic>{ SchoolOfMagic.Conjuration }),
                ...
                new TemplatePerSchool("grass", new List<SchoolOfMagic>{ SchoolOfMagic.Conjuration }),
