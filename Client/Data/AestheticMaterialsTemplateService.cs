    ...
    public class AestheticMaterialsTemplateService : BaseMaterialsTemplateService
    {
        protected override void CreateTemplates()
        {
            _templates = new List<TemplatePerSchool>
            {
                ...
                new TemplatePerSchool("foam"),
                new TemplatePerSchool("viscous liquid"),
                ...
                new TemplatePerSchool("sparks"),
                new TemplatePerSchool("ice"),
                new TemplatePerSchool("snow"),
                new TemplatePerSchool("mist"),
                new TemplatePerSchool("smoke"),
                new TemplatePerSchool("shadows", new List<SchoolOfMagic>{ SchoolOfMagic.Necromancy, SchoolOfMagic.Illusion, SchoolOfMagic.Enchantment, SchoolOfMagic.Divination }),
                ...
                new TemplatePerSchool("copper", new List<SchoolOfMagic> { SchoolOfMagic.Transmutation, SchoolOfMagic.Evocation, SchoolOfMagic.Abjuration }),
                new TemplatePerSchool("chains", new List<SchoolOfMagic> { SchoolOfMagic.Conjuration, SchoolOfMagic.Evocation, SchoolOfMagic.Abjuration }),

                new TemplatePerSchool("stone"),
                new TemplatePerSchool("soil"),
                new TemplatePerSchool("dirt"),
                new TemplatePerSchool("dust"),
                new TemplatePerSchool("sand"),
                new TemplatePerSchool("granite"),
                new TemplatePerSchool("sandstone"),
                new TemplatePerSchool("limestone"),
                new TemplatePerSchool("gravel"),
                new TemplatePerSchool("pebbles"),
                new TemplatePerSchool("obsidian"),
                new TemplatePerSchool("quartz"),
                new TemplatePerSchool("pumice"),
                ...
                new TemplatePerSchool("coal"),
                new TemplatePerSchool("charcoal"),
                ...
                new TemplatePerSchool("wax"),
                new TemplatePerSchool("books"),
                new TemplatePerSchool("wires"),
                ...
                new TemplatePerSchool("parchment"),
