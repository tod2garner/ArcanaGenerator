    ...
    public class NameFragmentTemplateService
    {
        ...
        private void CreateEmotionsList()
        {
            _emotions = new List<TemplatePerEffectType>()
            {
                ...
                new TemplatePerEffectType("Loathing", new List<SchoolOfMagic>{ SchoolOfMagic.Necromancy, SchoolOfMagic.Enchantment }, new List <EffectType> { EffectType.Debuff, EffectType.Damage }),
