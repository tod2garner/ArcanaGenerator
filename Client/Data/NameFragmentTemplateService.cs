    ...
    public class NameFragmentTemplateService
    {
        ...
        private void CreatePossesivesList()
        {
            _possesives = new List<TemplatePerSchool>()
            {
                ...
                new TemplatePerSchool("Fosco's", new List<SchoolOfMagic>{ SchoolOfMagic.Transmutation, SchoolOfMagic.Evocation }),
                ...
                new TemplatePerSchool("Gelduin's"),
                new TemplatePerSchool("Elander's"),
                new TemplatePerSchool("Ethren's"),
                new TemplatePerSchool("Thallan's"),
                new TemplatePerSchool("Urilont's"),
        ...
        private void CreateEmotionsList()
        {
            _emotions = new List<TemplatePerEffectType>()
            {
                ...
                new TemplatePerEffectType("Precision"),
