    ...
    public class NameFragmentTemplateService
    {
        ...
        private void CreateEmotionsList()
        {
            _emotions = new List<TemplatePerEffectType>()
            {
                ...
                new TemplatePerEffectType("Loyalty", new List<EffectType>{ EffectType.Buff }),
                new TemplatePerEffectType("Devotion", new List<EffectType>{ EffectType.Buff }),
                ...
                new TemplatePerEffectType("Malice", new List<SchoolOfMagic>{ SchoolOfMagic.Necromancy, SchoolOfMagic.Evocation }),
                ...
                new TemplatePerEffectType("Envy", new List <EffectType> { EffectType.Debuff, EffectType.Damage }),
                new TemplatePerEffectType("Insanity", new List<SchoolOfMagic>{ SchoolOfMagic.Enchantment, SchoolOfMagic.Necromancy }),
                new TemplatePerEffectType("Vanity"),
                ...
                new TemplatePerEffectType("Loathing", new List <EffectType> { EffectType.Debuff, EffectType.Damage }),
        ...
        private void CreateCoresList()
        {
            _cores = new List<TemplatePerEffectType>
            {
                ...
                new TemplatePerEffectType("omen", new List <SchoolOfMagic> { SchoolOfMagic.Divination }),
        ...
        private void CreateAdjectivesList()
        {
            _adjectives = new List<TemplatePerEffectType>
            {
                ...
                new TemplatePerEffectType("lucky", new List<SchoolOfMagic> { SchoolOfMagic.Divination }),
                new TemplatePerEffectType("grand", new List<SchoolOfMagic>{ SchoolOfMagic.Illusion, SchoolOfMagic.Evocation }),
                new TemplatePerEffectType("fortuitous", new List<SchoolOfMagic> { SchoolOfMagic.Divination }),
                ...
                new TemplatePerEffectType("mutilated", new List<EffectType>{ EffectType.Damage, EffectType.Debuff }),
                ...
                new TemplatePerEffectType("umbral", new List<EffectType>{ EffectType.Damage, EffectType.Debuff }),
