    ...
    public class NameFragmentTemplateService
    {
        ...
        private void CreateCoresList()
        {
            _cores = new List<TemplatePerEffectType>
            {
                ...
                new TemplatePerEffectType("duality"),
        ...
        private void CreateAdjectivesList()
        {
            _adjectives = new List<TemplatePerEffectType>
            {
                ...
                new TemplatePerEffectType("forgotten"),
                new TemplatePerEffectType("forsaken"),
                new TemplatePerEffectType("craven", new List<SchoolOfMagic>{ SchoolOfMagic.Necromancy, SchoolOfMagic.Enchantment }, new List<EffectType>{ EffectType.Damage, EffectType.Debuff }),
                new TemplatePerEffectType("ravenous", new List<SchoolOfMagic>{ SchoolOfMagic.Necromancy }, new List<EffectType>{ EffectType.Damage, EffectType.Debuff }),
                ...
                new TemplatePerEffectType("cerulean"),
                new TemplatePerEffectType("vermilion "),
                new TemplatePerEffectType("viridian  "),
                new TemplatePerEffectType("crimson"),
                new TemplatePerEffectType("ochre"),
                new TemplatePerEffectType("saffron"),
                new TemplatePerEffectType("citrine", new List<SchoolOfMagic>{ SchoolOfMagic.Divination, SchoolOfMagic.Enchantment }, new List<EffectType>{ EffectType.Buff }),
                new TemplatePerEffectType("lavender", new List<SchoolOfMagic>{ SchoolOfMagic.Divination, SchoolOfMagic.Enchantment }, new List<EffectType>{ EffectType.Buff }),
