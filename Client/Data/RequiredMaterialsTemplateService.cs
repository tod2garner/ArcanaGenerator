    ...
    public class RequiredMaterialsTemplateService : BaseMaterialsTemplateService
    {
        protected override void CreateTemplates()
        {
            _templates = new List<TemplatePerSchool>
            {
                ...
                new TemplatePerSchool("three small feathers"),
                ...
                new TemplatePerSchool("a small piece of granite"),
                new TemplatePerSchool("a small sandstone rock"),
                new TemplatePerSchool("a fragment of limestone"),
                ...
                new TemplatePerSchool("a vial of oil with a claw in it"),
                new TemplatePerSchool("four pressed three-leaf clovers"),
                ...
                new TemplatePerSchool( "an apple seed"),
                new TemplatePerSchool( "tomato seeds"),
                ...
                new TemplatePerSchool( "a small comb made from a sea shell"),
                new TemplatePerSchool("a piece of turtle shell"),
                new TemplatePerSchool( "pressed flowers, gathered in direct sunlight"),
                ...
                new TemplatePerSchool("soap carved into the shape of an acorn"),
                new TemplatePerSchool("soap carved into the shape of a leaf"),
                new TemplatePerSchool("soap carved into the shape of a bird"),
                ...
                new TemplatePerSchool("dice made from bones"),
                ...
                new TemplatePerSchool("petals from flowers gathered at midnight"),
                new TemplatePerSchool("stems from flowers gathered during a new moon"),
